            ...
            <div class="col-md-9">
                <div class="edu-team-area team-area-1 gap-tb-text">
                    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
                        <h3 class="mb-0">Printed Invoice</h3>

                        <form method="GET" action="{{ route('invoice.index') }}" class="d-flex align-items-center gap-2">
                            <input type="text" name="q" value="{{ request('q') }}" class="form-control"
                                placeholder="Search invoices..." />
                            <a href="{{ route('invoice.index') }}" class="h-100">
                    ...
                    <x-student.table :values="$invoices" view_route="invoice.show" status_route="invoice.status"
