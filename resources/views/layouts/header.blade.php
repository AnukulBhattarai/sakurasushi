            ...
            @isset($organization->email)
                <div class="it-info-wrapper mb-20 d-flex align-items-center">
                    ...
                    <div class=itoffcanvas__info-address>
                        <span>Email</span>
                        <a href="maito:{{ $organization->email }}">{{ $organization->email }}</a>
                    </div>
                </div>
            @endisset
                                    ...
                                    <a href="mailto:{{ $organization->email }}">
                                        <span>
                                            <svg width=20 height=20 viewBox="0 0 20 20" fill=none
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                                    d="M10.0002 0C4.47784 0 0.000244141 4.47784 0.000244141 10C0.000244141 15.5222 4.47784 20 10.0002 20C15.5225 20 20.0002 15.5222 20.0002 10C20.0002 4.47784 15.5225 0 10.0002 0ZM16.6668 6.66667L10.0002 11.6667L3.3335 6.66667V3.33333L10.0002 8.33333L16.6668 3.33333V6.66667ZM10.0002 13.3333L16.6668 8.33333V16.6667H3.3335V8.33333L10.0002 13.3333Z"
                                                    fill=currentcolor />
                                            </svg>
                            ...
                            <ul>
                                <div class=it-header-2-top-social>
                                    @isset($organization->facebook)
                                        <a href="{{ $organization->facebook }}"><i class="fab fa-facebook-f"></i></a>
                                    @endisset
                                    @isset($organization->twitter)
                                        <a href="{{ $organization->twitter }}"><i class="fab fa-twitter"></i></a>
                                    @endisset
                                    ...
                                    @isset($organization->instagram)
                                        <a href="{{ $organization->instagram }}"><i class="fab fa-instagram"></i></a>
                                    @endisset
                                </div>
                            </ul>
                        </div>
            ...
            <div class="it-header-wrap p-relative">
                <div class="row align-items-center">
                    ...
                    <style>
                        ...
                        /* Second-level submenu (right side of first-level) */
