<footer class="footer-section section-bg-2 fix">
    <div class="footer-top-shape">
        <img src="{{ asset('img/footer-top.png') }}" alt="shape-img">
    </div>
    <div class="zebra-shape float-bob-y">
        <img src="{{ asset('img/about/zebra.png') }}" alt="shape-img">
    </div>
    <div class="container">
        <div class="contact-info-area">
            ...
            @isset($organization->email)
                <div class="contact-info-items wow fadeInUp" data-wow-delay=".5s">
                    ...
                    <div class="content">
                        <p style="font-size: 16px;">Make a Quote</p>
                        <h3 style="font-size: 16px;">
                            <a href="https://mail.google.com/mail/?view=cm&fs=1&to={{ $organization->email }}"
                                target="_blank" class="link" style="text-transform: lowercase;">
                                {{ $organization->email }}
                            </a>
                        </h3>
                    </div>
                        ...
                        <div class="widget-head">
                            <a href="{{ route('home') }}">
                                @isset($organization->logo)
                                    <img src="{{ asset('storage/' . $organization->logo) }}" style="height: 120px;"
                                        alt="logo-img">
                                @else
                                    <img src="{{ asset('img/logo/logo.png') }}" style="height: 120px;" alt="logo-img">
                                @endisset
                            </a>
                            <br>
                            @isset($organization->other['slogan'])
                                <p>{{ $organization->other['slogan'] }}</p>
                            @endisset
                        </div>
                        <div class="footer-content">
                            <div class="social-icon d-flex align-items-center">
                                @isset($organization->facebook)
                                    <a target="_blank" href="{{ $organization->facebook }}"><i
                                            class="fab fa-facebook-f"></i></a>
                                @endisset
                                @isset($organization->twitter)
                                    <a target="_blank" href="{{ $organization->twitter }}"><i
                                            class="fab fa-twitter"></i></a>
                                @endisset
                                @isset($organization->linkedin)
                                    <a target="_blank" href="{{ $organization->linkedin }}"><i
                                            class="fab fa-linkedin-in"></i></a>
                                @endisset
                                @isset($organization->instagram)
                                    <a target="_blank" href="{{ $organization->instagram }}"><i
                ...
                @isset($footerNotice)
                    <div class="col-xl-4 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".7s">
                        <div class="career-footer">
                            <a target="_blank" href="{{ $footerNotice->link }}">
                                <img src="{{ asset('storage/' . $footerNotice->thumbnail) }}"
                                    style="height: 100%; width:100%; object-fit:contain;" alt="img">
                            </a>
                        </div>
                    </div>
                @endisset
    ...
    <div class="footer-bottom">
        <div class="f-bottom-shape">
            <img src="{{ asset('img/footer-bottom.png') }}" alt="shape-img">
        </div>
        <div class="container">
            <div class="footer-wrapper d-flex align-items-center justify-content-between">
                <p class="wow fadeInLeft color-2" data-wow-delay=".3s">
                    Developed by <a href="https://aitechnology.com.np/">Ant Institute of Technology</a>
                </p>
